...
$this->registerJsVar('poy', $YeekeeChit->id);
$this->registerJsVar('poyCancelUrl', Url::to(['yeekeechit/cancel-yeekeechit', 'id' => $YeekeeChit->id, 'uid' => $dataUser->id]));
?>
	...
	<div class="widget-content ">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    ...
                    <?php if($YeekeeChit->getCanReChit()){ ?>
                        <p><br><a href="#" class="btn btn-outline-danger btn-sm abort_poy">คืนโพย</a></p>
                    <?php } ?>
                </div>
                <div class="panel-body">
...
<?php echo $this->render('modal_confirm_delete', [
    'orderId' => $YeekeeChit->id
]) ?>
